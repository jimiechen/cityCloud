...
class CacheDBItemsDao extends DatabaseAccessor<CustomDatabase> with _$CacheDBItemsDaoMixin {
  // this constructor is required so that the main database can create an instance
  // of this object.
  CacheDBItemsDao(CustomDatabase db) : super(db);
  ...
  static clearTable() {
    CustomDatabase().cacheDBItemsDao.deleteAllForType();
  }
}
