...
class _PwdEditTextState extends State<PwdEditText> {
  ...
  void initState() {
    ...
    if (widget.defaultpwd != null) {
      _inputAccount = widget.defaultpwd;
    }
  }
  ...
  Widget build(BuildContext context) {
    TextEditingController _controller = new TextEditingController.fromValue(
        TextEditingValue(text: _inputAccount, selection: new TextSelection.fromPosition(TextPosition(affinity: TextAffinity.downstream, offset: _inputAccount.length))));
    return new Container(
      child: new TextField(
        ...
        decoration: InputDecoration(
          ...
          enabledBorder: UnderlineInputBorder(borderSide: BorderSide(color: Color(0xffDADADA))),
