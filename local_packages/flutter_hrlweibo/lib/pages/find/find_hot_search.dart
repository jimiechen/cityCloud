          ...
          child: Center(
            child: Row(
              ...
              children: <Widget>[
                ...
                Container(
                  child: Text(String.fromCharCode(mHotSearchList[index].hotattitude) + "",
                      style: TextStyle(
                        fontSize: 10,
                        color: Colors.grey,
                      )),
                ...
                children: <Widget>[
                  NestedScrollView(headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
                    ...
                    return CustomScrollView(
                      slivers: <Widget>[
                        SliverOverlapInjector(handle: NestedScrollView.sliverOverlapAbsorberHandleFor(contexta)),
                        SliverToBoxAdapter(
                          child: Container(
                                ...
                                Expanded(
                                  ...
                                  child: Center(
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        Image.asset(
                                          Constant.ASSETS_IMG + 'hot_search_bottom1.png',
                                          width: 20,
                                          height: 20,
                                          fit: BoxFit.fill,
                                        ),
                                        Text(
                                          "热搜榜",
                                          style: TextStyle(color: Color(0xffE0905D), fontSize: 12),
                                        )
                                      ],
                                    ),
                                  ),
                                ...
                                Expanded(
                                  ...
                                  child: Center(
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        Image.asset(
                                          Constant.ASSETS_IMG + 'hot_search_bottom2.png',
                                          width: 20,
                                          height: 20,
                                          fit: BoxFit.fill,
                                        ),
                                ...
                                Expanded(
                                  ...
                                  child: Center(
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        Image.asset(
                                          Constant.ASSETS_IMG + 'hot_search_bottom3.png',
                                          width: 20,
                                          height: 20,
                                          fit: BoxFit.fill,
                                        ),
